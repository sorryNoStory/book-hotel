...
export const roomData = [
  {
    ...
    name: 'Superior Room',
    description:
      'Comfortable and spacious with essential amenities.',
    facilities: [
  ...
  },
  {
    ...
    name: 'Signature Room',
    description:
      'Luxurious with elegant decor and modern furnishings.',
    facilities: [
      { name: 'Wifi', icon: <FaWifi /> },
      { name: 'Coffee', icon: <FaCoffee /> },
      { name: 'Bath', icon: <FaBath /> },
  ...
  },
  {
    ...
    name: 'Deluxe Room',
    description:
      'Perfect for both business and leisure travelers with plush bedding and additional amenities.',
    facilities: [
      { name: 'Wifi', icon: <FaWifi /> },
      { name: 'Coffee', icon: <FaCoffee /> },
      { name: 'Bath', icon: <FaBath /> },
  ...
  },
  {
    ...
    name: 'Luxury Room',
    description:
      'High-end furnishings and deluxe en-suite bathroom with additional complimentary breakfast.',
    facilities: [
      { name: 'Wifi', icon: <FaWifi /> },
      { name: 'Coffee', icon: <FaCoffee /> },
      { name: 'Bath', icon: <FaBath /> },
  ...
  },
  {
    ...
    description:
      'Ultimate opulence and comfort with a spacious living area, private balcony, and fully equipped kitchenette.',
    facilities: [
      { name: 'Wifi', icon: <FaWifi /> },
      { name: 'Coffee', icon: <FaCoffee /> },
      { name: 'Bath', icon: <FaBath /> },
